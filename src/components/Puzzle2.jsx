...
const TimelinePuzzle = () => {
  ...
  const calculateSize = () => {
    if (dimensions.width === 0) return { width: 100, height: 50 };
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-20 w-full flex-grow bg-black/20 rounded-lg sm:rounded-xl mt-2 sm:mt-4 p-2 flex justify-center items-start flex-wrap gap-2 sm:gap-3 md:gap-4 overflow-y-auto">
